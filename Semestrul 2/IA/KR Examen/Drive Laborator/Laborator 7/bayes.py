...
class Nod:
    def __init__(self, identificator, probabl=None,parinti=[], fii=[], tabel=[], observatie=None):
...
class Retea:
    def __init__(self, fisier):
        ...
        for textObs in listaObservatii:
            ...
            self.graf[identif].observatie=1 if val=='1' else 0
